...
<body>
        ...
        <div class='collapse navbar-collapse' id='navbarSupportedContent'>
            <div class='navbar-nav ml-auto'>
                ...
                <ul class='nav nav-pills flex-column flex-sm-row'>
                    ...
                    <li class='nav-item'>
                        <a class='flex-sm-fill text-sm-center nav-link active link' href='contact.php'>Contact</a>
                    </li>
                    <li class='nav-item'>
                        <a class='flex-sm-fill text-sm-center nav-link text-warning' href='admin.php'>Admin</a>
                    </li>
                </ul>
            </div>
    ...
    <header class='mt-5'>
        <div class='container text-center'>
            <h1 class='display-1'>Days left for my internship</h1>
        </div>
    </header>
            ...
            <div class='col-md-6'>
                ...
                <form method='post' action=''>
                    <div class='form-group'>
                        ...
                        <textarea name='message' class='form-control mt-2' id='exampleTextarea' rows='5' placeholder='Say something!!!'></textarea>
                        <input type='submit' class='float-right mt-2 btn btn-primary' name='send_form'>Submit</button>
                    </div>
                </form>
            </div>
